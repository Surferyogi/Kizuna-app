...
// Handles push notifications. Cache managed by vite-plugin-pwa.
...
// ── Notification click — open app, keep in Notification Centre ─
self.addEventListener('notificationclick', event => {
  // Do NOT call event.notification.close() — keeps it in Notification Centre
